...
public class QuarterProject245 extends javax.swing.JFrame {
    ...
    public QuarterProject245()
    {
        ...
        //for esc function to exit prgram
       ...
       //for running F1 to work on window
         getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(KeyStroke.getKeyStroke(KeyEvent.VK_F1,0),"ShowAuthors");
         getRootPane().getActionMap().put("ShowAuthors",  new AbstractAction(){
            public void actionPerformed(ActionEvent e)
            {
                System.out.print("Shows the Authors");
                JOptionPane.showMessageDialog(mainPanel, "Daniel Fierros:009061390\nTroy Dome:009572849","Autohrs",JOptionPane.PLAIN_MESSAGE);
            }
            });
    }
    /**
    ...
    private void initComponents() {
        ...
        */
        ...
        ProjectTitle.setBounds(80, 20, 500, 38);
        ...
        TeamName.setBounds(220, 300, 160, 22);
        ...
        sudokuQuit.setBounds(510, 310, 75, 29);
        ...
        griduser73.setBounds(180, 350, 20, 27);
